...
!!! tip "알아두기"
    ...
    AWS 명령 줄 인터페이스 명령은 [AWS CLI에서 상위 수준(s3) 명령 사용](https://docs.aws.amazon.com/cli/latest/userguide/cli-services-s3-commands.html) 문서를 참조하세요.
...
!!! tip "알아두기"
    [참고]
    보다 자세한 내용은 [AWS SDK for Java](https://docs.aws.amazon.com/en_us/sdk-for-java/) 설명서 문서를 참조하세요.

### Boto3 - Python SDK

!!! tip "알아두기"
    [참고]
    보다 자세한 내용은 [AWS SDK for Python(Boto3)](https://docs.aws.amazon.com/en_us/pythonsdk/) 설명서 문서를 참조하세요.